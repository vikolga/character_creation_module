...
def attack(char_name: str, char_class: str) -> str:
    """Определяем урон нанесенный противнику при атаке."""
    if char_class == 'warrior':
        damade = 5 + randint(3, 5)
        return (f'{char_name} нанёс урон противнику равный {damade}')
    if char_class == 'mage':
        damade = 5 + randint(5, 10)
        return (f'{char_name} нанёс урон противнику равный {damade}')
    if char_class == 'healer':
        damade = 5 + randint(-3, -1)
        return (f'{char_name} нанёс урон противнику равный {damade}')


def defence(char_name: str, char_class: str) -> str:
    """Уровень защиты героя."""
    if char_class == 'warrior':
